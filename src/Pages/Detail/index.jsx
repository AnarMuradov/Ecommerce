    ...
    <section className="detail">
      <div className="detailContainer">
        ...
        <div className="detailContainer__info">
          ...
          <div className="detailContainer__info__productRating">
            <div className="detailContainer__info__productRating__rating">
              <i class="fa-solid fa-star" style={{ color: "#dfac20" }}></i>
              <i class="fa-solid fa-star" style={{ color: "#dfac20" }}></i>
              <i class="fa-solid fa-star" style={{ color: "#dfac20" }}></i>
              <i class="fa-solid fa-star" style={{ color: "#dfac20" }}></i>
              <i class="fa-solid fa-star" style={{ color: "#747e90" }}></i>
            </div>
            <span style={{ opacity: "0.5" }}>(100 Reviews)</span>
            <span style={{ color: "#0F6" }}>in Stock</span>
          </div>


          
          <div className="detailContainer__info__price">
            <p>${api.price}</p>
          </div>



          <div className="detailContainer__info__description">
            <p>{api.description}</p>
          </div>
          ...
          <div className="detailContainer__info__colors">
            <h5>Colors:</h5>
          </div>
          ...
          <div className="detailContainer__info__size">
            <h5>Size</h5>
            <div>XS</div>
            <div>S</div>
            <div>M</div>
          ...
          <div className="detailContainer__info__buy">
            <div className="detailContainer__info__buy__count">
              <span className="detailContainer__info__buy__minus">-</span>
              <div>2</div>
              <span className="detailContainer__info__buy__plus">+</span>
            </div>
            <button>Buy Now</button>
            <i onClick={() => addWishList(api)} class="fa-regular fa-heart"></i>
          </div>
          ...
          <div className="detailContainer__info__delivery">
            <div className="detailContainer__info__delivery__free">
              <svg
              ...
              <div className="detailContainer__info__delivery__free__content">
                <span>Free Delivery</span>
                <h5>Enter your postal code for Delivery Availability</h5>
              </div>
            </div>
            <div className="detailContainer__info__delivery__return">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="40"
                height="40"
